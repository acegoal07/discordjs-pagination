...
module.exports = PaginationBase = async({
   ...
   try {
      ...
      // Interaction
         ...
         // Run
         return Promise.resolve(InteractionPagination(interaction, pageList, buttonList, timeout, autoDelete, privateReply, progressBar, proSlider, proBar, authorIndependent, selectMenu));
      }
