...
const { EmbedBuilder } = require("discord.js"),
   ...
   AutoButtonBuilder = require("../util/AutoButtonBuilder"),
   PageBuilder = require("../util/PageBuilder"),
   ButtonBuilder = require("../util/ButtonBuilder");
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Params ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
...
module.exports = pagination = async({
   ...
   try {
      ...
      if (!pageList && pageBuilderInfo) pageList = await PageBuilder(pageBuilderInfo);
      if (!pageList) throw new Error("Missing pages");
      if (buttonBuilderInfo && !buttonList) buttonList = await ButtonBuilder(buttonBuilderInfo);
      if (autoButton && !buttonList && !buttonBuilderInfo) buttonList = await AutoButtonBuilder(pageList.length, autoDelButton);
