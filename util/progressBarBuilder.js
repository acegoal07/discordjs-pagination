...
// Params ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 * @param {Number} pageList - An array of the embeds
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Progress bar maker ////////////////////////////////////////////////////////////////////////////////////////////////////
module.exports = progressBarBuilder = async(pageList, pageNumber, proSlider, proBar) => {
   // Progress maths
   const progress = pageNumber + 1;
   const emptyProgress = pageList - (pageNumber + 1);
   // Progress text
