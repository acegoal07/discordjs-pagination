...
const progressBarBuilder = require('@acegoal07/discordjs-pagination/util/progressBarBuilder');
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Params ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 ...
 * @param {Boolean} progressBar - If progressBar is enabled
 * @param {Boolean} privateReply - If privateReply is enabled
 * @returns The pagination
*/
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Interaction pagination ////////////////////////////////////////////////////////////////////////////////////////////////
module.exports = InteractionPagination = async (interaction, pages, buttonList, timeout, autoDelete, progressBar, privateReply) => {
   // Set page number
   let page = 0;
   // Create embed
   ...
   let curPage
   if (privateReply) {
      interaction.deferred !== true ? await interaction.reply("The reply has been sent privatly") : await interaction.editReply("The reply has been sent privatly");
