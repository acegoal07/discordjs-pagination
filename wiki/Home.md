...
- `.setPages(pages)`
  - Required. Accepts an array of `EmbedPageBuilder`, `ImagePageBuilder`, `TextPageBuilder`, `ContainerPageBuilder`,`TextDisplayPageBuilder`, and/or `SectionPageBuilder` instances
- `.setButtons(buttons)`
