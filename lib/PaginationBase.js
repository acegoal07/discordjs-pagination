...
module.exports = PaginationBase = async({
   ...
   try {
      ...
      if (selectMenu && (buttonList || autoButton.toggle || autoButton.deleteButton)) process.emitWarning("PaginationBase WARNING: SelectMenu overwrites any button settings, remove all button settings to stop getting this message");
