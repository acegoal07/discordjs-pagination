 ...
 *    pageBuilderInfo: Array,
 *    buttonBuilderInfo: Array,
 *    ephemeral: Boolean,
 *    autoButton: {
 *       toggle: Boolean,
...
exports.MessagePagination = async(paginationInfo, options) => {
   try {
      ...
      const paginationContent = {
         ...
         components: [options.selectMenu.toggle ? await SelectMenuCreator(pageList.length, options.selectMenu.labels) : new ActionRowBuilder().addComponents(paginationInfo.buttonList)], fetchReply: true
      };
      let pagination;
      if (privateReply) {
