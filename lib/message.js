...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Message pagination ////////////////////////////////////////////////////////////////////////////////////////////////////
module.exports = MessagePagination = async (message, pages, buttonList, timeout, replyMessage, autoDelete, progressBar) => {
   // Set page number
   let page = 0;
   // Create embed
   ...
   let curPage = replyMessage ? await message.reply(curPageContent) : await message.channel.send(curPageContent);
   // Create filter
   let filter
